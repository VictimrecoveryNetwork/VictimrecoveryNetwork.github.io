...
<head>
  <meta charset="UTF-8">
  <title>ScamReport – Thank You</title>
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <script src="https://cdn.tailwindcss.com"></script>
</head>
...
<body class="bg-slate-100 min-h-screen flex items-center justify-center">
  ...
  <div class="bg-white shadow-lg rounded-2xl p-8 max-w-md text-center">
    <h1 class="text-2xl font-bold text-emerald-600 mb-3">Thank you for your report</h1>

    <p class="text-sm text-slate-600 mb-4">
      Your information has been recorded. While we cannot guarantee recovery of funds, your report helps protect others.
    </p>

    <p class="text-sm text-slate-500 mb-2">Your reference ID:</p>
    <p id="refId" class="text-xl font-mono font-semibold text-slate-800 mb-6"></p>

    <a href="index.html"
       class="inline-block bg-emerald-500 hover:bg-emerald-600 text-white px-5 py-2 rounded-lg text-sm font-semibold">
      Submit another report
    </a>
  </div>

  <script>
    const ref = sessionStorage.getItem("scamReportRef");
    document.getElementById('refId').textContent = ref || "N/A";
  </script>
